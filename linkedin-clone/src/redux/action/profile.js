...
// export const modalExperiencesFetch = (id, idJob) => {
//   return async (dispatch) => {
//     try {
//       let response = await fetch(`https://striveschool-api.herokuapp.com/api/profile/${id}/experiences/${idJob}`, {
//         method: "GET",
//         headers: {
//           Authorization:
//             "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NTcxYzlhYzBkOGEyMDAwMThhNDhhM2MiLCJpYXQiOjE3MDYwOTE1MDUsImV4cCI6MTcwNzMwMTEwNX0.wH2VfmxlAU88LH_llTaiiDJwpbdcCfSgscNbK5cy1CY",
...
//         console.log(res);
//         dispatch({ type: SET_MODAL_EXPERIENCES, payload: res });
//       } else {
//         throw new Error("Fetch EXPERIENCES Fallita");
//       }
//     } catch (error) {
