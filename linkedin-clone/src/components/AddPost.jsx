          ...
          <Row>
            <Col className="col-5">
              ...
              <button className="btn btn-light text-start  text-opacity-50 fw-medium  rounded-1  opacity-75">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" fill="#6586e4" viewBox="0 0 512 512">
            ...
            <Col>
              ...
              <button className="btn btn-light text-start  text-opacity-50 fw-medium  rounded-1 w-10 h-10 opacity-75">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" fill="#b0822e" viewBox="0 0 448 512">
            ...
            <Col className="col-4">
              {" "}
              <button className="btn btn-light text-start  text-opacity-50 fw-medium  rounded-1  w-10 h-10 opacity-75">
                <svg xmlns="http://www.w3.org/2000/svg" width="20px" fill="#c46d4f" viewBox="0 0 512 512">
                  {" "}
